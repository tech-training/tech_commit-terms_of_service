...
4. 当社は、当社の基準に従って、第1項に基づいて登録申請を行った登録希望者（以下「登録申請者」といいます）の登録の可否を判断し、当社が登録を認める場合には、その旨を登録申請者に通知し、当社の指定するチャットツールへの招待等を行います。登録申請者の登録ユーザーとしての登録は、当社が本項の通知を行ったことをもって完了したものとします。  
...
6. 当社は、登録申請者が、以下の各号のいずれかの事由に該当する場合は、登録および再登録を拒否することがあり、またその理由について一切開示義務を負いません。  
  ...
  5. 第11条（登録抹消等）に定める措置を受けたことがある場合  
  6. その他、当社が登録を適当でないと判断した場合

## 第4条（登録事項の変更）
登録ユーザーは、登録事項に変更があった場合、当社の定める方法により当該変更事項を遅滞なく当社に通知するものとします。  

## 第5条（パスワード、ユーザーID、メールアドレスの管理）
1. 登録ユーザーは、**自己の責任において、本サービスに関するパスワード・ユーザーID・メールアドレスを適切に管理および保管する**ものとし、これを第三者に利用させ、または**貸与、譲渡、名義変更、売買等をしてはならない**ものとします。  
2. パスワード、ユーザーID、またはメールアドレスの管理不十分、使用上の過誤、第三者の使用等によって生じた損害に関する責任は登録ユーザーが負うものとし、当社は一切の責任を負いません。  
...
3. 利用開始時以降は、登録ユーザーが自主的に退会、または当社が登録の抹消をしない限り、**原則毎月自動的に本サービスの利用を継続する更新（以下「自動更新」といいます）が行われる**ものとします。なお、**自動更新は利用開始時を基準として1ヶ月を経過する毎に利用開始時と同日に行われる**ものとします。  
4. 前項により自動更新される場合、利用料金は、登録ユーザーが会員登録の際に指定した支払方法により自動的に決済されるものとします。
5. **退会後の再開には再度本サービス所定の初期費用がかかる**ものとします。ただし、自動更新による**定期決済の最初の失敗から7日以内の、「継続利用について確認する期間」（以下「継続利用確認期間」といいます）中に当月決済を終えた場合には当社ウェブサイトに表示する利用料金のみの支払いにて再開が可能**となります。また、再開時は当該の当社ウェブサイトに表示する利用料金を支払った時点を基準として1ヶ月を経過する毎に自動更新が行われるようになるものとします。
...
5. 本サービスを通じ、以下に該当し、または該当すると当社が判断する情報を当社または本サービスの他の利用者に送信すること  
  ...
  4. 隠語等を含む過度にわいせつな表現を含む情報  
  5. 民族、宗教、人種、性別または年齢等に関する差別を助長する表現を含む情報
  ...
  12. 未成年に対する飲酒、タバコ、賭博等を推奨・誘引する公序良俗に反する表現を含む情報
6. 本サービスのネットワークまたはシステム等に過度な負荷をかける行為  
7. 本サービスの運営を妨害するおそれのある行為
8. 本サービスの利用権限等の技術的利用制限を回避しようとする行為  
9. 本サービスまたは当社ウェブサイトにおける不具合やセキュリティ上の問題を発見した場合に、これを周知または攻撃を幇助する行為  
10. 当社のネットワークまたはシステム等に不正にアクセスし、または不正なアクセスを試みる行為  
11. 第三者になりすます行為  
12. 本サービスの他の利用者のID、パスワード、メールアドレスを利用する行為  
13. **当社が事前に許諾しない本サービス上での宣伝、広告、勧誘、または営業行為**  
14. 本サービスの他の利用者の情報（メールアドレスやLINE IDの個人情報などを含みます）の収集および、取得した個人情報を本人の同意なく第三者に提供する行為
15. 当社、本サービスの他の利用者またはその他の第三者に不利益、損害、不快感を与える行為  
16. 反社会的勢力等への利益供与  
17. 面識のない異性との出会いを目的とした行為  
18. **他の登録ユーザーに対して、過度に情報の供与や学習のサポートおよびチャットや通話等を強要するような行為**  
19. 当社が提供するキャンペーン・イベント・その他特別な利用条件の有る登録プランなどに対して、虚偽の情報により対象者として利用しようとする行為  
20. **故意に定期決済を失敗させて継続利用確認期間を発生させる行為**
21. 前各号の行為を直接または間接に惹起し、または容易にする行為、およびこれらを疑われる行為  
...
1. 当社は、以下のいずれかに該当する場合には、登録ユーザーに事前に通知することなく、本サービスの全部または一部の提供を停止または中断することができるものとします。  
  ...
  4. 本サービスと連携して使用される各種SNSのサービス、サーバーリソース、チャットやその他動画配信のツール等が不具合等によって停止した場合
  5. その他当社が停止または中断を必要と判断した場合
2. 当社は、本条件に基づき当社が行った措置に基づき登録ユーザーに生じた損害について一切の責任を負いません。
...
4.当社は、登録ユーザーの**QA掲示板での質問および回答内容、また学習に利用している教材の情報等の投稿情報を**、本サービスおよび本サイトの**告知（ＴＶ、雑誌、ブログを含むインターネットサービス等）のために利用できる**ものとします。ただし、個人が特定できないように適切な個人情報保護措置を取るものとします。
...
2. 当社の本サービス運用における人的およびシステム的不備が原因で、登録ユーザーとなってから最初の5営業日以上経っても本サービス（本サービスへのログイン、およびチャットや勉強会等含む）の全てを利用できなかった場合には、その詳細内容を本サービスのお問合せフォームよりご連絡を頂いた後、ご案内する所定の状況および状態確認用のフォームへその内容をご入力頂き、当社内で調査の上所定の手続きにて対応を行うものとします。（なお、チャット等への招待は決済完了後、通常2営業日中にはお送りしております。）
3. 当社は本サービスを提供すべき期間において、当社の瑕疵により、事前の通知なく登録ユーザーに対して本サービスの全てを提供しなかったときは、本サービスを利用できないことを当社が知った時刻から起算して連続して5日間本サービスを利用できなかったときに限り、登録ユーザーからの請求によって該当月の利用料金額を限度として損害の賠償を行うこととします。ただし、登録ユーザーが当該の請求が可能となった日から1ヶ月を経過する日までに請求をしなかった場合には、登録ユーザーはその権利を失うものとします。
